...
public class RouteData {
	...
	public static GeoRoute createAlsterRoute3() {
		...
		route.addWaypoint(new GeoPosition(53.598438, 10.004646));	
		route.addWaypoint(new GeoPosition(53.600020, 10.029511));	
		route.addWaypoint(new GeoPosition(53.5934594,10.019112));	
		route.addWaypoint(new GeoPosition(53.598438, 10.004646));
